package club.tesseract.immortal.npc

import club.tesseract.immortal.util.sendServer
...
class PacketNPC(val position: Pos, val hologramLines: List<Component>, val gameName: String, val playerSkin: PlayerSkin? = null, val entityType: EntityType = EntityType.PLAYER) {
    ...
    private val spawnPlayer = SpawnEntityPacket(playerId, uuid, 0, position, position.yaw, 0, 0, 0, 0)
